class BilateralOpenDeterministicGame():
    ...
    def setOpponentCommitment(self):
        self.bot1.opponentCommitType = self.bot2.opponentCoopCommitType
        self.bot2.opponentCommitType = self.bot1.opponentCoopCommitType
