from Interfaces import BilateralGame, ClosedGame, DeterministicGame
import Game

import bots

class BilateralClosedDeterministicGame(Game, BilateralGame, ClosedGame, DeterministicGame):
